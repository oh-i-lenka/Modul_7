...
//        creatingListOfOrders();
    ...
    static public List<Order> sortByPriceAndCity() {
        Collections.sort(listOfOrders, new Task_1_2_3.PriceCityComparator());
    ...
    static public boolean lookingForPetrov() {
        ...
        if (result = false) {
            System.out.println("The TreeSet does not contain any surname Petrov");
        }
        return result;
    }
    ...
    static public Order maxPrice() {
        ...
        System.out.println("The maximum price is " + maxPrice + " " + currencyMaxPrice);
...
//        creatingListOfUsers();
    ...
    static public List<User> putInMap(List<User> listOfUsers, User user) {
